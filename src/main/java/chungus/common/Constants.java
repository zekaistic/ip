...
/**
 * Centralised string and token constants to avoid magic strings
 * across the codebase.
 */
public final class Constants {
    ...
    public static final String MSG_EVENT_NEEDS_FROM_TO = "Event command must include both '/from' and '/to' followed by start and end times.";
